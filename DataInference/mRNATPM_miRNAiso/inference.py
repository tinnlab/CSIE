"""
Inference Script for Bidirectional mRNA-miRNAiso Transformer

Generate predictions using a trained model on new data.

Features:
- Load trained model from checkpoint
- Predict mRNA → miRNAiso or miRNAiso → mRNA
...
class Predictor:
    ...
    def predict_mrna_to_mirna(
        ...
        Returns:
            mirna_pred: (n_samples, n_genes) - Predicted miRNAiso expression
        """
        # Normalize input
    ...
    def predict_mirna_to_mrna(
        ...
        """
        Predict mRNA from miRNAiso.
        
        Args:
            mirna_input: (n_samples, n_genes) - miRNAiso expression (original scale)
            inverse_transform: Whether to transform back to original scale
    ...
    def predict_batch(
        ...
        Args:
            ...
            mirna_data: DataFrame with miRNAiso expression
...
def main():
    ...
    # Save mRNA → miRNAiso predictions
    ...
    # Save miRNAiso → mRNA predictions
    predictor.save_predictions(
        mrna_pred,
